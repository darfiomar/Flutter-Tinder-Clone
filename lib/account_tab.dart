  ...
  Widget build(BuildContext context) {
    List<Widget> yoFuck = [
      swipeWidgetText("assets/location_icon.png", "Swipe around the world!",
          "Passport to anywhere with GoEXPLORE"),
      swipeWidgetText("assets/key_icon.png", "Control your profile",
          "Limit what other can see with GoEXPLORE "),
    ];
    return Scaffold(
      body: Container(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                      colors: [
                                        Color.fromRGBO(174, 127, 252, 1),
                                        Color.fromRGBO(189, 127, 238, 1),
                                        Color.fromRGBO(132, 127, 238, 1)
                                      ],
